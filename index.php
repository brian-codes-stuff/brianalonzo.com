...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-22948979-1"></script>
<script>
...
<div id="wrapper">
  ...
  <a href="javascript:void(0);" class="icon" onclick="myFunction()">
       ...
       <section id="home">
          <div class="container">
            <div class="row">
              <div class="col-lg-12 mx-auto">
                  <span class="main-title">I Am A Web Marketing Consultant.</span>
                  <div class="video">
                      <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/295618283?portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
                  </div>
                  <a class="view js-scroll-trigger" href="#web-design-services">Learn More About My Services</a>
              </div>
              </div>
            </div>
        </section>
        <section class="panel" id="web-design-services">
          <div class="container">
            <div class="row">
              <div class="col-lg-12 mx-auto">
                  <h2>Website Design & Website Development</h2>
                  <hr>
                  <p class="center">All Of Your Website Needs Under One Umbrella.</p>
                  <hr>
                  <br>
                  <div class="row">
    ...
    <div class="col-md-12">
        <div class="row">
            <a href="img/cleveland-web-design-client-embracing-futures.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4">
                <img src="img/cleveland-web-design-client-embracing-futures.jpg" class="img-fluid">
            </a>
            <a href="img/cleveland-web-design-client-hearing-aids.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4">
                <img src="img/cleveland-web-design-client-hearing-aids.jpg" class="img-fluid">
            </a>
            <a href="img/cleveland-web-design-clien-rmr.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4">
        ...
        <div class="row" style="margin-top:35px;">
            ...
            <a href="img/clevleand-web-design-client-renew.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4">
                <img src="img/clevleand-web-design-client-renew.jpg" class="img-fluid">
            </a>
            <a href="img/cleveland-web-design-client-aron.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4">
                <img src="img/cleveland-web-design-client-aron.jpg" class="img-fluid">
            </a>
        </div>
    </div>
               </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input id="form_phone" type="phone" name="phone" class="form-control" placeholder="Please enter your phone number *" required="required" data-error="Valid phone number is required.">
                    <div class="help-block with-errors"></div>
                </div>
                 <div class="form-group">
                    <label for="form_interest">I am Interested In:</label>
                     <textarea id="form_interest" type="text" name="interest" class="form-control" placeholder="Please tell me a little bit about your project." required="required" data-error="Please tell me something..."></textarea>
                    <div class="help-block with-errors"></div>
                </div>
            </div>
        </div>
